...
class ModuleGenerator extends Generator
{
    ...
    public function generateResources()
    {
        ...
        $this->console->call('module:make-request', [
            ...
            'module' => $this->getName(),
            'permission' => 'admin.access.'.$this->getName().'.create',
        ]);

        $this->console->call('module:make-request', [
            'name' => 'Manage'.$this->getName().'Request',
            'module' => $this->getName(),
            'permission' => 'admin.access.'.$this->getName().'.manage',
        ]);

        $this->console->call('module:make-request', [
            'name' => 'Update'.$this->getName().'Request',
            'module' => $this->getName(),
            'permission' => 'admin.access.'.$this->getName().'.edit',
        ]);

        $this->console->call('module:make-request', [
            'name' => 'Show'.$this->getName().'Request',
            'module' => $this->getName(), 
            'permission' => 'admin.access.'.$this->getName().'.view',
        ]);
