...
@section ('title', __('secondtest::labels.backend.secondtest.management') . ' | ' . __('secondtest::labels.backend.secondtest.edit'))
...
@section('content')
{{ html()->modelForm($secondtest, 'PATCH', route('admin.secondtest.update', $secondtest->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('secondtest::labels.backend.secondtest.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
